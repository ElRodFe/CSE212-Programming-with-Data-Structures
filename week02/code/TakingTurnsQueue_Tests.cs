...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: Person class (PersonQueue.cs) was not behaving like a FIFO
    ...
    // Defect(s) Found: Queue not behaving like a FIFO
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: Person with infinite turns was never checked for re-enqueued
