public class SimpleQueue
{
    public static void Run()
    {
        ...
        // Defect(s) Found: Trying to dequeue from second item in the list instead of first as it should
        ...
        value = queue.Dequeue();
        Console.WriteLine(value);
        // Defect(s) Found: Items were added at the front of the queue, not the back
    ...
    {
        _queue.Add(value); //Items shoud be enqueue at the back of the queue
    }
    ...
    private int Dequeue()
    {
        ...
        var value = _queue[0]; //For dequeue first item is at index 0, not 1
        _queue.RemoveAt(0); //For dequeue first item is at index 0, not 1
        return value;
    }
}